...
import { calculateAllStats, getHeroIdsFromCompId } from '../utils/stats';
                                ...
                                <div>
                                  ...
                                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                                    {Object.values(pStat.byComposition).map((compDetail) => {
                                      const [h1Id, h2Id] = compDetail.heroIds || getHeroIdsFromCompId(compDetail.compId || '');
                                      const h1 = getHeroById(h1Id);
                                      const h2 = getHeroById(h2Id);
