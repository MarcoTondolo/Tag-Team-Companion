        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400">
              Regolamento Solitario Ufficiale Tag Team di Michael Kelley
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="p-3 bg-slate-950/80 border border-slate-800 rounded-2xl space-y-2">
          <div className="text-xs font-black text-amber-400 flex items-center justify-between">
            <span>Fase di Combattimento (Tracker Round)</span>
            <span className="text-[10px] text-slate-500 font-normal">Max 1 carta / round</span>
          </div>
          <button
            type="button"
          ...
          >
            ...
            <span className="text-[10px] uppercase font-bold">
              {isCardAddedThisRound ? 'Aggiunta ✓' : 'Da aggiungere'}
            </span>
          </button>
        </div>
      </div>
      ...
      <div className="bg-slate-950/90 border border-slate-800 rounded-2xl p-3.5 space-y-3">
        <div className="flex items-center justify-between border-b border-slate-800 pb-2">
          <div className="flex items-center gap-2">
            ...
            >
              🛡️ Verifiche Disaccordo (Mismatch)
            </button>
            <button
              type="button"
        ...
        {activeTab === 'priorities' && (
          <div className="space-y-2">
            <div className="text-xs font-extrabold text-amber-400 mb-1">
              Scegli la carta migliore per il Bot seguendo questa scala:
            </div>
