          ...
          <div className="max-w-md mx-auto bg-slate-900 border border-slate-800 rounded-2xl p-8 text-center space-y-4 shadow-xl">
            ...
            <form onSubmit={handleQuickAdd} className="flex gap-2 pt-2">
              <input
                  ...
                  className={`px-4 py-2 bg-slate-950 border rounded-xl text-sm text-white focus:outline-none w-full transition-colors ${
                      quickErrorMessage
                          ? 'border-red-500'
                          : 'border-slate-700'
                  }`}
              ...
              <button
                  ...
                  className="px-4 py-2 bg-amber-500 text-slate-950 font-bold rounded-xl text-sm hover:bg-amber-400 disabled:opacity-50 flex items-center gap-1 shrink-0 cursor-pointer"
              >
            ...
            {quickErrorMessage && (
                <p className="text-red-400 text-xs flex items-center justify-center gap-1 font-medium">
